...
func (self *WbSocietiesType) Insert() (string, error) {
	var err error
...
func (self *WbSocietiesType) GetByID(query *GetQuery) (*GetModel, error) {
	db := pgsql.Open()
...
func (self *WbSocietiesType) List(query *Query) ([]*ListModel, int64, error) {
	if query == nil {
		query = new(Query)
	}
	db := pgsql.Open()
...
func (self *WbSocietiesType) GetCount(db *sqlx.DB, query *Query, whereSql ...string) (int64, error) {
	if query == nil {
		query = new(Query)
	}
 ...
 */
func (self *WbSocietiesType) Update(query *UpdateByIDQuery) error {
	if query == nil {
...
// 删除，批量删除
func (self *WbSocietiesType) Delete(query *DeleteQuery) error {
	if query == nil {
...
// 启用禁用店铺
func (self *WbSocietiesType) ToggleDisabled(query *DisabledQuery) error {
	if query == nil {
		return errors.New("无操作条件")
	}
	if strings.TrimSpace(query.ID) == "" {
