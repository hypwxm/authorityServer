...
const table_name = "g_menu"

func insertSql() string {
	return fmt.Sprintf("insert into %s (createtime, isdelete, disabled, id, name, path, icon, parent_id) select :createtime, :isdelete, :disabled, :id, :name, :path, :icon, :parent_id returning id", table_name)
